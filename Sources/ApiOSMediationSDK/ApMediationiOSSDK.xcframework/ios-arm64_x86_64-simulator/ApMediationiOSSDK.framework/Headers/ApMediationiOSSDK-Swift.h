...
#ifndef APMEDIATIONIOSSDK_SWIFT_H
#define APMEDIATIONIOSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ApMediationiOSSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_PROTOCOL("_TtP17ApMediationiOSSDK16ApBannerListener_")
...
SWIFT_CLASS("_TtC17ApMediationiOSSDK18ApBannerAdListener")
@interface ApBannerAdListener : NSObject <ApBannerListener>
- (void)onAdOpened;
- (void)onAdClicked;
- (void)onAdClosed;
- (void)onAdImpression;
...
SWIFT_PROTOCOL("_TtP17ApMediationiOSSDK24ApInterstitialAdListener_")
@protocol ApInterstitialAdListener
@optional
- (void)onAdPresented;
- (void)onAdClicked;
- (void)onAdDismissed;
...
SWIFT_CLASS("_TtC17ApMediationiOSSDK22ApInterstitialListener")
@interface ApInterstitialListener : NSObject <ApInterstitialAdListener>
- (void)onAdClicked;
- (void)onAdImpression;
- (void)onAdPresented;
- (void)onError;
...
SWIFT_CLASS("_TtC17ApMediationiOSSDK18ApMediationAdapter")
@interface ApMediationAdapter : NSObject <GADMediationAdapter>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
+ (void)setUpWithConfiguration:(GADMediationServerConfiguration * _Nonnull)adConfiguration completionHandler:(GADMediationAdapterSetUpCompletionBlock _Nonnull)completionHandler;
